	...
	(function($) {
		$.fn.pane3D = function(options) {
			...
			var $env = this,
				...
				$w = $(window),
				scrolled = 0,
				docHeight, distance3d = o.spacing,
				levels = $panes.length - 1,
			...
			$(window).scroll(function() {
				...
				currentLevel = (Modernizr.csstransforms3d) ? (Math.round(scrolled * levels) + levels) : (Math.round(scrolled * levels));
